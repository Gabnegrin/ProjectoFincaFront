...
export class CambiarComponent {
  cliente: Propietario = new Propietario(null, null, null, null, null, null, null, 0, false, null)
  ...
  Iracomponente(){
  this.cliente.id = this.datoscompartidos.Propietario.id;
  ...
  postCliente(cliente: Propietario){
    if(cliente.id != null){
      this.axiosHandlerService.putDatat("http://localhost:8080/api/javeriana/grupo25/propietario", cliente)
      .then(response => {
