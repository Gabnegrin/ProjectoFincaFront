...
export class CalificarComponent {
  ...
  calificar(){
    ...
    if(this.datcompartido.Solicitud.c_cliente != null && this.cali_propiet != null){
      this.aux1 = (this.cali_propiet + this.datcompartido.Solicitud.c_cliente)/2;
      this.datcompartido.Solicitud.c_cliente = this.aux1;
    }
